...
CREATE TABLE MULTAS (
    ...
    CONSTRAINT FK_Mult_Matr FOREIGN KEY (Matricula) REFERENCES VEHICULOS(Matricula) ON DELETE CASCADE,
    CONSTRAINT FK_Mult_NIF FOREIGN KEY (NIF_Agente) REFERENCES AGENTES(NIF) ON DELETE CASCADE,
    CONSTRAINT FK_Mult_Cod FOREIGN KEY (Cod_I) REFERENCES INFRACCIONES(Cod_I) ON DELETE CASCADE
);
